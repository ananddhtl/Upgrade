    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('Esewa Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Esewa Client ID')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ESEWA_CLIENT_ID" value="{{  env('ESEWA_CLIENT_ID') }}" placeholder="{{ translate('Esewa Client ID') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ESEWA_TRANSACTION_URL">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Esewa Transaction Url')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ESEWA_TRANSACTION_URL" value="{{  env('ESEWA_TRANSACTION_URL') }}" placeholder="{{ translate('Esewa Transaction Url') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ESEWA_VERIFICATION_URL">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Esewa Verification Url')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="ESEWA_VERIFICATION_URL" value="{{  env('ESEWA_VERIFICATION_URL') }}" placeholder="{{ translate('Esewa Verification Url') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Esewa Sandbox Mode')}}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="esewa_sandbox" type="checkbox" @if (get_setting('esewa_sandbox') == 1)
                                        checked
                                    @endif>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('Khalti Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Khalti Public Key')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="KHALTI_PUBLIC_KEY" value="{{  env('KHALTI_PUBLIC_KEY') }}" placeholder="{{ translate('Khalti Public Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="KHALTI_SECRET_KEY" value="{{  env('KHALTI_SECRET_KEY') }}" placeholder="{{ translate('Khalti Secret Key') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="KHALTI_VERIFICTION_URL">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Khalti Verification Url')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="KHALTI_VERIFICTION_URL" value="{{  env('KHALTI_VERIFICTION_URL') }}" placeholder="{{ translate('Khalti Verification Url') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Khalti Sandbox Mode')}}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="khalti_sandbox" type="checkbox" @if (get_setting('khalti_sandbox') == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
