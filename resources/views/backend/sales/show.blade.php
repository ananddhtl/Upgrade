        ...
        <div class="card-body">
            <div class="row gutters-5">
                ...
                @php
                    ...
                    if(!($order->tracking_code===null || $order->tracking_code==="")){
                        $response = Http::withHeaders([
                                'Authorization' => 'Token dafc4c5ea79ed44524e74c410673d7291b0b69ed',
                                'Content-Type' => 'application/json'
                            ])->get("https://portal.nepalcanmove.com/api/v1/order?id=$order->tracking_code");
                ...
                @if ($order->seller_id == $admin_user_id || get_setting('product_manage_by_admin') == 1)
                    ...
                    <div class="col-md-3 ml-auto">
                        ...
                        <button type="button" id="send_delivery_request" onclick="sendDeliveryRequest()" class="btn btn-primary">Send</button>
                        @else
...
@section('script')
    <script type="text/javascript">
        ...
        function sendDeliveryRequest() {
            ...
            $.post('{{ route('orders.send_delivery_request') }}', {
                _token: '{{ @csrf_token() }}',
                order_id: order_id
            }, function(data) {
                ...
                if(data==1){
                    ...
                    AIZ.plugins.notify('success', '{{ translate('Delivery Request has been Sent') }}');
                    location.reload();
                } else {
                    AIZ.plugins.notify('danger', data);
                }
            });
        }
