                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="local_shipping"  onclick='localShippinghandleClick(this);' value="1">
                                    <span></span>
                                </label>
                            </div>
                        </div>

                        {{-- <input type="text" name="local_shipping_address" placeholder="Enter your Price" class="form-control" /></td> --}}
                        ...
                        <table class="table table-bordered" id="dynamicTable">  
                            ...
                            <tr>  
                                <td><select class="form-control" name="local_shipping_address[0][name]" id="local_shipping_address[0][name]">
                                ...
                                <td><input type="text" name="local_shipping_address[0][price]" placeholder="Enter your Price" class="form-control" /></td>  
