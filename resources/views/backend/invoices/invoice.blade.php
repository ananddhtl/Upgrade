...
<body>
	<div style="padding:20px;">
	    ...
	    <div style="padding: 3rem;margin-top:5rem;">
	        <div class="label_container" style="border:2px solid;border-radius:10px;height:400px;width: 50%;">
				<table>
					<tr>
						<td class="text-left">
							@if($logo != null)
				...
				<table style="border-top:1px solid;">
				    <tr>
			            <td class="text-left">
			                ...
			                <img src="{{ static_asset('assets/img/sabxaappqr.png') }}" height="80px" style="margin-left:20px;">
					        ...
					        <table class="text-right sm-padding small strong">
						        <tbody>
							        <tr>
							            ...
							            <td>{{ translate('Shipping Type') }}- Standard</td>
							        </tr>
                                    <tr>							            
							        ...
							        <tr>
							            ...
							            <td>{{ $orderDetail->product->weight }} kg</td>
							        </tr>
							        <tr>
				...
				<table style="border-top:1px solid;border-collapse: separate !important;">
				    <tr>
				        <td>
				            <p>Nepal Can Move</p>
				            <p><b>Tracking #{{ $order->tracking_code }}</b></p>
				        </td>
				        <td>
