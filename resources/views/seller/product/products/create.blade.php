        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="tags[]" value='[{"value":"sabxa"}]'>
                    <!--<div class="form-group row">-->
            ...
            <input type="hidden" class="form-control" name="meta_title" value="">
            <input type="hidden" class="form-control" name="meta_description" value="">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="est_shipping_days" min="1" step="1"
                                placeholder="{{translate('Shipping Days')}}" value="3">
                            <div class="input-group-prepend">
...
//     $('.category_sug').click(function(){
//         selected_value = $("input[name='category_suggestion']:checked").val();
...
// $("#input[name='category_suggestion']").click(function(){
//     // alert('You clicked radio!');
//     var value = $("#input[name='category_suggestion']").val();
//   $("#category_id").val(value).change();
...
// });
    ...
    // $(".category_sug").change(function(){
    //     var val = $(".category_sug:checked").val();
    //     alert(val);
    // });
    ...
    $("[name=shipping_type]").on("change", function (){
        ...
        // $('input[type="radio"][name="category_suggestion"]').click(function() {
            
        //     alert('hello');
        //     // var v = $(this).val();
        //     // $("#category_id").val(v).change();
        ...
        $('input[name="name"]').on('keyup input', function() {
            ...
            $.ajax({
                ...
                type:"POST",
                url:'{{ route('seller.products.category_suggestion') }}',
                data:{
