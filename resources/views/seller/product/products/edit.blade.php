...
<form class="" action="{{route('seller.products.update', $product->id)}}" method="POST" enctype="multipart/form-data"
    ...
    <input type="hidden" class="form-control" name="meta_title" value="{{ $product->meta_title }}">
    <input type="hidden" class="form-control" name="meta_description" value="{{ $product->meta_description }}">
    <input type="hidden" name="meta_img" value="{{ $product->meta_img }}" class="selected-files">
    <input type="hidden" placeholder="{{translate('Slug')}}" id="slug" name="slug"
