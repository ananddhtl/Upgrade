                                        ...
                                        <div class="row gutters-10">
                                            ...
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input id="esewa-payment-option" value="esewa" class="online_payment" type="radio"
                                                        name="payment_option">
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        <img src="{{ static_asset('assets/img/cards/esewa-payment.png') }}"
                                                            class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('Esewa') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input id="khalti-payment-option" value="khalti" class="online_payment" type="radio"
                                                        name="payment_option">
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        <img src="{{ static_asset('assets/img/cards/khalti-payment.png') }}"
                                                            class="img-fluid mb-2">
                                                        <span class="d-block text-center">
                                                            <span
        ...
        <div class="modal fade"  id="loadingModal" data-backdrop="static" data-keyboard="false" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content p-5">
                    <center >Payment Verifying...</center>
                </div>
            </div>
        </div>
    </section>
        ...
        function submitOrder(el) {
            ...
            if ($('#agree_checkbox').is(":checked")) {
                if (minimum_order_amount_check && $('#sub_total').val() < minimum_order_amount) {
                    ...
                    // check if selected payment method is esewa
                    // if it is esewa then redirect to esewa payment settings first.
                    
                    // =============== CODE ADDED BY KITWOSD TEAM =============
                    if ($("#esewa-payment-option").is(":checked")) {
                        $(document).ready(function() {
                            var data = new FormData();


                            
                            data.append('owner_id', $("input[name='owner_id']").val());
                            data.append('payment_option', $("input[name='payment_option']:checked").val());
                            data.append('additional_info', $("textarea[name='additional_info']").val());
                            ...
                            $.ajax({
                                ...
                                method: "POST",
                                url: "{{ route('payment.esewa') }}",
                                data: data,
                                cache: false,
                                contentType: false,
                                processData: false,
                                success: function(data, textStatus, jqXHR) {
                                    if (data['data'] == 'start-esewa-processing') {
                                        
                                        
                                        var priceNum = parseFloat($('.cart-total td strong').text().substring(3));
                                        ...
                                        var params= {
                                            ...
                                            su: "https://sabxa.com/checkout/order-confirmed-esewa",
                                            fu: "https://sabxa.com"
                                        }
                    ...
                    else if ($("#khalti-payment-option").is(":checked")) {
                            ...
                            $.ajax({
                                ...
                                success: function(data, textStatus, jqXHR) {
                                    if (data['data'] == 'start-esewa-processing') {
                                            ...
                                            "eventHandler": {
                                                onSuccess (payload) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        method: "POST",
                                                        url: "{{ route('payment_verify.khalti') }}",
                                                        data:{
                                                            token:payload.token,
                                                        ...
                                                        success: function(data, textStatus, jqXHR) {
                                                            ...
                                                            if(data.response=='success'){
                                                                location.href = "https://sabxa.com/checkout/order-confirmed-khalti";
                                                            }
                                                ...
                                                onError (error) {
                                                    location.href = "https://sabxaweb.test";
                                                },
                                                onClose () {
                                        ...
                                        checkout.show({amount: priceNum*100});
