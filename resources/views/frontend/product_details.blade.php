                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <form id="option-choice-form">
                                ...
                                @if ($detailedProduct->local_shipping)
                                    <hr>
                                    <span class="text-white fw-600 px-2" style="background-color: #3675cc">
                                        {{ translate('Selected Areas Only') }}
                                    </span>
                                    <br>
                                    <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                                        <div class="col-sm-2">
                                            <div class="opacity-50 my-2">{{ translate('Delivery Areas') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="product-price">
                                                <span>{{$detailedProduct->delivered_areas}}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="col-10">
                                        <a href="{{ route('returnpolicy') }}" target="_blank">
                                            @if ($detailedProduct->refundable==='1')
                                                ...
                                                <img src="{{ static_asset('assets/img/refundable.jpg') }}" height="46">
                                            @else
                                                
                                                <img src="{{ static_asset('assets/img/nonrefundable.jpg') }}"
                                                    height="46">
                                            @endif
