...
class PaymentTypesController
{
    ...
    public function getList(Request $request)
    {
        ...
        if (get_setting('esewa_sandbox') == 1){
            //esewa add
            $payment_type = array();
            $payment_type['payment_type'] = 'esewa_payment';
            $payment_type['payment_type_key'] = 'esewa';
            $payment_type['image'] = static_asset('assets/img/cards/esewa-logo.png');
            $payment_type['name'] = "eSewa";
            $payment_type['title'] = "eSewa Payment";
            $payment_type['offline_payment_id'] = 0;
            $payment_type['details'] = "";
            array_push($payment_types,$payment_type);
        }
        ...
        if (get_setting('khalti_sandbox') == 1){
            //Khalti add
            $payment_type = array();
            $payment_type['payment_type'] = 'khalti_payment';
            $payment_type['payment_type_key'] = 'khalti';
            $payment_type['image'] = static_asset('assets/img/cards/khalti-payment.png');
            $payment_type['name'] = "Khalti";
            $payment_type['title'] = "Khalti Payment";
            $payment_type['offline_payment_id'] = 0;
            $payment_type['details'] = "";
            array_push($payment_types,$payment_type);
        }
