            ...
            'data' => $this->collection->map(function ($data) {
                ...
                if(!($data->tracking_code===null || $data->tracking_code==="")){
                    ...
                    if($response->status()==200){
                        ...
                        $delivery_status_string = $response["last_delivery_status"];
                        if($delivery_status_string==='Delivered'){
                ...
                return [
                    ...
                    'shipping_type_string' => $data->shipping_type != null ? ucwords(str_replace('_', ' ', $data->shipping_type)) : "Standard",
