...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('products/category/{id}', 'category_products');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function() {
    ...
    Route::group(['prefix' => 'checkout'], function() {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::get('/order-confirmed-esewa', 'order_confirmed_by_esewa')->name('order_confirmed_by_esewa');
            Route::get('/order-confirmed-khalti', 'order_confirmed_by_khalti')->name('order_confirmed_by_khalti');
            Route::post('/payment-verify/khalti', 'khalti_verify')->name('payment_verify.khalti');
            Route::post('/payment', 'checkout')->name('payment.checkout');
            
            Route::post('/esewa_checkout', 'esewa_checkout')->name('payment.esewa');
    ...
    Route::controller(WalletController::class)->group(function () {
        ...
        Route::post('/online_recharge', 'online_recharge')->name('recharge.online');
        Route::post('/online_recharge-verify/khalti', 'khalti_verify_recharge')->name('recharge_verify.khalti');
        Route::get('/recharge-confirmed-esewa', 'recharge_confirmed_by_esewa')->name('recharge_confirmed_by_esewa');
        Route::get('/recharge-confirmed-khalti', 'recharge_confirmed_by_khalti')->name('recharge_confirmed_by_khalti');
    });
