...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::post('payments/pay/esewa', 'App\Http\Controllers\Api\V2\PaymentController@esewaPayment')->middleware('auth:sanctum');
    Route::post('payments/pay/khalti', 'App\Http\Controllers\Api\V2\PaymentController@khaltiPayment')->middleware('auth:sanctum');
    ...
    Route::post('wallet/online-recharge', 'App\Http\Controllers\Api\V2\WalletController@online_recharge')->middleware('auth:sanctum');
