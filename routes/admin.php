...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/products/category_suggestion', 'category_suggestion')->name('products.category_suggestion');
    ...
    Route::controller(BusinessSettingsController::class)->group(function () {
        Route::post('/business-settings/addSliderImage', 'addSliderImage')->name('business_settings.addSliderImage');
    ...
    Route::controller(OrderController::class)->group(function () {
        ...
        Route::post('/orders/send_delivery_request', 'send_delivery_request')->name('orders.send_delivery_request');
